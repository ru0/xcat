...
class Requester:
    ...
    def payload_to_parameters(self, payload: str):
        ...
        if self.injector is not None:
            ...
            #dict['FlowSn'] = '25 and 1=1'
            print(params[self.target_parameter])
        # must urlencode the char if the par in get method.
        #for param in params:
